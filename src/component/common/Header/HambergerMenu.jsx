...
const HambergerMenu = () => {
  ...
  return (
    <div className="z-50  max-sm:mr-[40px] md:hidden max-md:-mr-[550px] max-md:mt-12 ">
      <button className="">
        <IoMenu
          size={45}
        ...
        />
        {isOpen && (
          <div className=" absolute right-0  w-auto h-[100vh] bg-white shadow-lg rounded-md  dark:bg-slate-900">
            <IoMdClose
              size={35}

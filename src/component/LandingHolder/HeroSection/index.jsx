...
const index = () => {
  return (
    <div className="flex justify-start h-[600px] w-[100%] dark:bg-slate-800">
      ...
      <div>
        <div className="w-[800px] h-[600px] max-sm:w-[500px] max-sm:h-[300px] max-sm:relative max-sm:left-52 max-sm:-ml-32 mt-10  ml-4  max-sm:-mt-1   -m-10">

...
const index = () => {
  return (
    <div className='h-[600px] bg-white dark:bg-[#22445D;]'>
      <div className="border-transparent  w-[70%] h-[380px] flex justify-center flex-wrap mt-16 mr-[15%] gap-4">
        ...
        <div className="w-[40%] h-[400px]">
          <button className=' shadow w-[160px] h-[28px] relative top-3 right-8 rounded-lg bg-[#EFEEFE]  dark:text-black'> درباره ما بیشتر بدانید</button>
          <div className="div">
          <h1 className=' text-2xl font-bold relative top-8 right-8'>هزاران</h1>
            <img className='w-[100px] relative right-28  ' src='./Vector.png' alt='img'/>
...
صحبت در مورد پایه پلتفرم وب.</p>
           ...
           <NavLink to={'/courses'}>
             <button className='border-2 border-black  w-[208px] h-[33px] shadow rounded-lg bg-[#5751E1] relative bottom-8 right-6 hover:bg-slate-500'> <span className='text-[#FFFFFF]'> رایگان آزمایش کنید </span></button>
           </NavLink>

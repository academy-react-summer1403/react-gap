    ...
    <div className="flex flex-wrap justify-center ">
      ...
      <div className="flex flex-wrap gap-1 w-[75%] h-[250px] justify-center md:justify-around mx-auto mb-10">
        ...
        <div className="border-2 w-[350px] h-[170px] rounded-2xl bg-[#C9E4E9]">
          ...
          <h1 className="relative bottom-7 right-24"> اساتید با تجربه </h1>
          <p className="text-xs relative right-4"> معلمان متخصص با دانش و تجربه خود، راهنمایی‌های موثری برای دانش‌آموزان ارائه می‌دهند. </p>
        </div>
          ...
          <h1 className="relative bottom-7 right-24">   دوره های موثر </h1>
          <p className="text-xs relative right-4"> دوره‌های مؤثر، توانمندی‌های یادگیرندگان را به‌طرز چشم‌گیری بهبود می‌بخشند. </p>
          </div>
          ...
          <h1 className="relative bottom-7 right-24">  دریافت گواهینامه </h1>
          <p className="text-xs relative right-4">  دریافت گواهینامه نشان‌دهنده توانایی و تخصص فرد در یک حوزه خاص است. </p>
          </div>

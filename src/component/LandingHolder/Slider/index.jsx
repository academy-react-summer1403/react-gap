      ...
      <div className=" h-[150px]  text-center m-20 ">
        ...
        <div className="  div">
          ...
          <div className=" flex flex-wrap justify-center w-[50%] h-[700px] relative bottom-[500px] right-[200px] gap-2 ">
            ...
            <div className="border-2 w-[280px] h-[282px] relative bottom-10 bg-[#ffffffc3] hidden lg:block">
              <div className="hidden lg:block w-[90%] h-[50%] mr-4 mt-2">
                <img src="./photo1.png"/>
              ...
              <h1 className='relative top-3 text-start text-xl right-4 font-bold hidden lg:block'> آموزش کار با جاوا اسکریپت</h1>
            </div>

            <div className="border-2  w-[280px] h-[282px]  bg-[#ffffffc3] hidden lg:block ">
            <div className=" hidden lg:block  w-[90%] h-[50%] mr-4 mt-2">
                <img src="./photo2.png"/>
                <MdOutlineContactPhone className='relative top-12 w-6 h-6' />
                <h1 className='text-[10px] relative top-7 left-14'>  پشتیبانی کد دات </h1>
            ...
            <div className="border-2  w-[280px] h-[282px] relative bottom-11 bg-[#ffffffc3] hidden lg:block">
            <div className="hidden lg:block  w-[90%] h-[50%] mr-4 mt-2">
                <img src="./photo2.png"/>
                <MdOutlineContactPhone className='relative top-12 w-6 h-6' />
                <h1 className='text-[10px] relative top-7 left-14'>  پشتیبانی کد دات </h1>
            ...
            <div className="shadow w-[280px] h-[282px] bg-[#ffffffc3] hidden lg:block ">
            <div className=" hidden lg:block  w-[90%] h-[50%] mr-4 mt-2">
                <img src="./photo1.png"/>
                <MdOutlineContactPhone className='relative top-12 w-6 h-6' />
                <h1 className='text-[10px] relative top-7 left-14'>  پشتیبانی کد دات </h1>

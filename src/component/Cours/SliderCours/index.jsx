...
const index = () => {
  ...
  return (
    <div className="h-[1100px] ">
        ...
        {SliderCourses.map((item) => {
          return (
            <div className="h-[900px]">
              <Swiper
                className=" w-[95%] h-[700px] relative top-20"
      ...
      <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg relative bottom-24 right-[700px] bg-[#c0470a] ">
        مشاهده مقالات بیشتر{" "}
      </button>
    </div>
  );

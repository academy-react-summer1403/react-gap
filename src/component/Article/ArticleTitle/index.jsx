    ...
    return (
        ...
        <div className=' flex flex-wrap justify-center w-[85%]  mx-auto mt-32 rounded-[30px] bg-[#FBF6F6;]'>
            ...
            <div className='w-[95%] h-[650px] mt-20 rounded-3xl bg-[#ffffff;] shadow-2xl '>
                ...
                {/* <div className='boeder-4 flex flex-wrap  h-20 w-full bg-pink-300 mt-16'>
                <div  className=' '>
                    <h1 className='border-2 w-24 h-9  mr-11 mt-'>  نویسنده </h1> 
                    <ImUser className='border-2 w-8 h-10' />
    ...
    <div className="w-[70%] h-[100px] bg-[#ffffff] rounded-l-xl rounded-t-xl shadow-2xl">
        <h1 className='mr-5'>عنوان :</h1>
        <div><h2 className='mr-5'>لورم ایپسوم محبوب ترین و استانداردترین متن ساختگی است که توسط توسعه دهندگان وب، تایپوگراف ها و طراحان استفاده می شود.
    ...
    <div className="w-[30%] h-[100px] bg-[#ffffff] rounded-l-xl rounded-t-xl shadow-2xl ">
        <h1 className='mr-5'>عنوان :</h1>
        <div><h2 className='mr-5'>لورم ایپسوم محبوب  توسط توسعه دهندگان وب، تایپوگراف ها و طراحان استفاده می شود.</h2></div>
    </div>
    </div>

...
const index = () => {
  return (
    <div className=" flex flex-wrap justify-center w-[85%]  mx-auto mt-32 rounded-[30px] bg-[#FBF6F6;] dark:bg-[#22445D;]">
      <div className="w-[85%] h-[650px] mt-24 dark:bg-[#22445D;]">
        <img src="./Mask2.png" alt="" />
      </div>
      <div className="w-[95%] h-[650px] mt-20 rounded-3xl bg-[#ffffff;] shadow-2xl dark:bg-[#22445D;]">
        <div className="">
        ...
        <div className="w-[95%] h-[570px] mx-auto mt-6">
          <h2 className="text-2xl tracking-wide leading-10 font-thin">
            لورم ایپسوم محبوب ترین و متن ساختگی است که توسط توسعه دهندگان وب،
            تایپوگراف ها و طراحان استفاده می شود. تکه های لاتین متن نشان می دهد
            که یک پروژه در حال توسعه است. لورم ایپسوم فقط برای توسعه دهندگان وب
            نیست. طراحان گرافیک نیز از آن با نرم افزارهای مختلفی مانند فوتوشاپ
            استفاده می کنند. لورم ایپسوم محبوب .{" "}
          </h2>
          ...
          <h2 className="text-2xl tracking-wide leading-10 font-thin">
            ...
            دهندگان وب، تایپوگراف ها و طراحان استفاده می شود. تکه های لاتین متن
            نشان می دهد که یک پروژه در حال توسعه است. لورم ایپسوم فقط برای توسعه
            دهندگان وب نیست. در حال توسعه است.
          </h2>
        </div>
        ...
        <div className="border-2 border-red-400 h-[10%] m-7 bottom-24 relative">
          <div className="border-2 border-red-400 w-[60%] h-[80%] m-2 flex justify-center gap-20">
            ...
            <div className="border-2 border-green-400 w-14 h-8 m-3">
              ...
              <h1 className="text-sm mr-16 relative bottom-6 font-thin w-20">
                کلمات کلیدی
              </h1>
            </div>
          </div>
      ...
      <div className=" w-[95%] h-[800px] mt-24">
        ...
        <div className="chat chat-start">
          ...
          <div className="w-[30%] h-[100px] bg-[#ffffff] rounded-l-xl rounded-t-xl shadow-2xl ">
            ...
            <div>
              <h2>
                لورم ایپسوم محبوب توسط توسعه دهندگان وب، تایپوگراف ها و طراحان
                استفاده می شود.
              </h2>
            </div>
          </div>

...
const AddCourseComment = () => {
  ...
  return (
    <div>
      <input type="text" placeholder="  کامنت شما "  onChange={(e)=>setMyTitle(e.target.value)}/>
      <textarea
...
<button onClick={addComment} className=" btn btn-outline mt-5 border-gray-400 ">ارسالش کن</button>
    </div>
  );
};

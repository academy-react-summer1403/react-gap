...
const Login = () => {
  ...
  <form action="">
          ...
          <div className='remember-forget'>
            ...
            <label className='relative top-[-18px] font-inter text-[#22445D] text-xs'><input type="checkbox" /> مرا به خاطر بسپارید</label>
          ...
          <br/>
          <button className='w-[340px] h-[40px] border-2 border-[#fffff] text-[#22445D] rounded-lg mt-4'> بازگشت به صفحه اصلی</button>

                        <br />
            <a className='  relative font-inter text-[#22445D] text-xs underline bottom-[-15px]' href='#'>یک حساب کاربری ایجاد کنید </a>

            <a className='relative right-20 font-inter text-[#22445D] text-xs underline   bottom-[-15px]' href='#'>فراموشی رمز</a>
